  ...
  return (
    <div className={`flex flex-col items-center justify-start min-h-full p-4 ${theme.font} max-w-4xl mx-auto w-full`}>
      <SEO 
        ...
        description="Easily encode or decode URLs to handle special characters and query strings."
        keywords="url encode, url decode, percent encoding, uri component, query string"
      />
      ...
      <div className="w-full bg-gray-800 p-6 rounded-2xl shadow-xl border border-gray-700 space-y-6">
        ...
        <div className="flex justify-center gap-4 bg-gray-900/50 p-2 rounded-xl w-fit mx-auto">
          <button
            ...
            className={`px-6 py-2 rounded-lg font-medium transition-all ${
              mode === 'encode' ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-400 hover:text-white hover:bg-gray-700'
            }`}
          >
            Encode
          </button>
          <button
            ...
            className={`px-6 py-2 rounded-lg font-medium transition-all ${
              mode === 'decode' ? 'bg-green-600 text-white shadow-lg' : 'text-gray-400 hover:text-white hover:bg-gray-700'
            }`}
          >
            Decode
          </button>
        ...
        {/* Action Button (Visual Separator) */}
        ...
        <div className="space-y-2 relative">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full h-32 bg-gray-950 border border-gray-700 rounded-xl p-4 text-green-400 font-mono resize-y focus:outline-none"
            />
            {output && (
              <button
                onClick={handleCopy}
